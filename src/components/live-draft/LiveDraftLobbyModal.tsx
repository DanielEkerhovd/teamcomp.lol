        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 px-4 min-h-20 rounded-lg bg-black/20 border border-white/10">
            <div className="relative shrink-0 w-8 h-8">
              ...
              {captainAvatarUrl && (
                <img src={captainAvatarUrl} alt="" className="absolute inset-0 w-8 h-8 rounded-full object-cover" referrerPolicy="no-referrer" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
              )}
            </div>
