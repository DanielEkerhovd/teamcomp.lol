-- Make submit_draft_action idempotent: use SELECT FOR UPDATE to serialize
-- concurrent calls, and return the existing action if already submitted.
-- This eliminates the 409 duplicate-key errors from timer/click races.
