-- Make submit_draft_action atomic: record action + advance game in one transaction.
-- Previously the client called advanceGame separately, causing 409 conflicts when
-- the action was recorded but the game index failed to advance.
