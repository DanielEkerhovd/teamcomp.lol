-- Update get_friends to include role information from profiles
-- Includes team name for role association
-- Also preserves blocked users array from previous migration
